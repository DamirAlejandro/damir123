...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { Categories: @register.Categories, Prodycts: @register.Prodycts, Quantity: @register.Quantity } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { Categories: @register.Categories, Prodycts: @register.Prodycts, Quantity: @register.Quantity } }
